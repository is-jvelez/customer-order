...
@Component({
  ...
  styles: [`
    ...
    .success-message { color: #2E7D32; font-size: 14px; margin-bottom: 8px; padding: 8px; background: #E8F5E9; border-radius: 4px; }
    .login-link { text-align: center; font-size: 14px; }
    .login-link a { color: #1565C0; text-decoration: none; font-weight: 500; }
  `],
})
